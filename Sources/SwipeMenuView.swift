...
public protocol SwipeMenuViewDataSource: class {
    ...
    func swipeMenuView(_ swipeMenuView: SwipeMenuView, imagesForItemAt index: Int) -> (UIImage?, UIImage?)?
    
    func swipeMenuView(_ swipeMenuView: SwipeMenuView, positionForImageAt index: Int) -> TitleImagePosition?
...
extension SwipeMenuView: TabViewDelegate, TabViewDataSource {
    ...
    public func tabView(_ tabView: TabView, imagesForItemAt index: Int) -> (UIImage?, UIImage?)? {
        return dataSource?.swipeMenuView(self, imagesForItemAt: index)
    }
    
    public func tabView(_ tabView: TabView, positionForImageAt index: Int) -> TitleImagePosition? {
        return dataSource?.swipeMenuView(self, positionForImageAt: index)
    }
}
